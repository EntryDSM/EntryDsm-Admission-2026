...
import { RequireApplicationPeriod } from "./components/RequireApplicationPeriod";
    ...
    children: [
      {
        ...
        children: [
          {
            // 접수 기간 밖이면 랜딩을 포함한 원서 화면을 막고 유저 앱으로 보낸다.
            // 제출 완료(/submitted)는 마감 직후에도 보여야 하므로 가드 밖에 둔다.
            element: <RequireApplicationPeriod />,
            children: [
              {
                path: "/",
                element: <RootLayout />,
