...
export const FaqPage = () => {
  ...
  const faqItems: FaqItem[] = [
    ...
    },
    {
      ...
      content:
        "저희 학교와 MOU를 맺은 기업수가 480개가 넘습니다. 졸업생들의 주요 진로는 웹, 앱, 보안, 게임, 임베디드 등 다양한 분야의 스타트업 취업, 대기업 계열사, 공무원, 공기업으로 진출하고 있습니다. 2023년 2월 졸업생 취업률 100%, 2024년 2월 졸업생 취업률 97%, 2025년 2월 졸업생 취업률 97%, 2026년 2월 졸업생 취업률 97% 입니다.",
      category: "career",
    },
    {
      id: 4,
